    ...
    <section className='navBarSection'>
      ...
      <div className='logoDiv'>
          ...
          <RiPlantFill className='icon'/>
            ...
            <h5 className='farmers-heading'>FertilizerSeller</h5>
          </a>
        </div>
        ...
        <div className={active}>
          <ul className='navLists flex'>
            ...
            <li className='navItem'>
              <a href='/fertilizer/market' className='navLink'>Market</a>
            </li>
            <li className='navItem'>
              <a href='/fertilizer/listing' className='navLink'>Listing</a>
            </li>
            <li className='navItem'>
              <a href='/fertilizer/support' className='navLink'>Support</a>
            </li>
