import './main.css'
import wholesaleAdvisory from '../../Components/Audio And Video/wholesaleAdvisory.jpeg'
...
import warehouseManagement from '../../Components/Audio And Video/warehouseManagement.jpeg'
...
const Data = [
  {
    id:1,
    imgSrc: wholesaleAdvisory,
    destTitle: 'Wholesale Advisory Services',
    description: 'wholesale advisory services provide wholesalers with guidance and \
                  recommendations to wholesale crops and mitigate risks. \
                  Timely, product specific and location-specific advice on wholesale decisions,transport and storage techniques \
                  aim to improve agricultural practices, increase yields, and enhance farm profitability.'
  },

  {
    id:2,
    imgSrc: warehouseManagement,
    destTitle: 'Warehouse management',
    description: 'Connecting with nearest warehouses to store products in quality'
  },
  ...
  return(
    <div className='main'>
      ...
      <div className='first-des'>
        ...
        Timely updates and forecasting provide current and predictive information about various subjects, including market trends, or emerging events. 
