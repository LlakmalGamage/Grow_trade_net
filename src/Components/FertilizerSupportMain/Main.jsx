...
const Data = [
  {
    ...
    description: 'Our platform provides support to fertilizer sellers aiming to improve crop quality through targeted advertisements.\
                  By connecting sellers with farmers seeking high-quality agricultural inputs, we facilitate informed decision-making and access to the latest innovations in fertilizer products and practices. \
                  Through networking opportunities and educational resources promoted on our platform,\
                  fertilizer sellers can engage with farmers, exchange feedback, and promote their products effectively, contributing to enhanced crop quality and sustainable agricultural outcomes.'
  },
  ...
  return(
    <div className='main'>
      ...
      <div className='first-des'>
        ...
        Timely updates and forecasting provide current and predictive information about various subjects, including market trends, and emerging events. 
        <h3><MdOutlineEdgesensorHigh className='icon'/>Understanding Your Needs</h3> 
        refers to the process of comprehending and recognizing the specific requirements, desires, or concerns of an individual, group, and organization. 
