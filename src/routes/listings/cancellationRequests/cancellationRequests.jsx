...
import "../cancellationRequests/cancellationRequests.css"
...
return (
  ...
  <div className="content-wrapper">
    <div className="content-header row">
      <div className="col"> 
        <h2 className="content-header-title">Cancellation Requests</h2>
      </div>
    ...
    <div className="content-body">
      ...
      {/* <div className="order-cards"> */}
        <div className="cancellationRequests-search-content">
          <form 
            name="cancellationRequestsSearch"
            method="post" 
            id="frm_id_cancellationRequestsSearch" 
            onsubmit="searchCancellationRequests(this)" 
            className="form" 
          >
            <div className="row">
              <div className="section">
                  ...
                  <input 
                    placeholder="Order Id/invoice No"
        ...
        <div className="cancellationRequests-Listing">
          <div className="row">
